...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fjugadoradd = new ew.Form("fjugadoradd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fjugadoradd;

    // Add fields
    var fields = currentTable.fields;
    fjugadoradd.addFields([
    ...
    // Form_CustomValidate
    fjugadoradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fjugadoradd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fjugadoradd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fjugadoradd" id="fjugadoradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
